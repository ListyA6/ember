...
(function (App) {
  ...
  function render(root, params) {
    ...
    roleGrid.appendChild(roleCard('trainer', 'users', "I'm a Trainer", 'Coach clients, assign plans, review progress'));
    roleGrid.appendChild(roleCard('client', 'user', "I'm a Client", 'Follow your plan, log workouts, track results'));
    ...
    page.appendChild(el('div', { class: 'muted t-xs center mt-3',
      ...
      text: 'Your data stays on this device. Build the streak, log every set, watch the ring close.' }));
